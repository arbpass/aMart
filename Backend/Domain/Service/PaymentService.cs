    ...
    public class PaymentService : IPaymentService
    {
        ...
        public Task<MerchantOrder> ProcessMerchantOrder(PaymentRequest payRequest)
        {
            try
            {
                ...
                Razorpay.Api.RazorpayClient client = new Razorpay.Api.RazorpayClient("rzp_test_1fTjSvIIgBkt6M", "R2CDK8zeMTezejzP0yPNyjZh");
                ...
                MerchantOrder order = new MerchantOrder
                {
                    ...
                    RazorpayKey = "rzp_test_1fTjSvIIgBkt6M",
        ...
        public async Task<string> CompleteOrderProcess(PaymentResponse _paymentResponse)
        {
            try
            {
                string paymentId = _paymentResponse.PaymentId;
                // This is orderId
                string orderId = _paymentResponse.OrderId;
                Razorpay.Api.RazorpayClient client = new Razorpay.Api.RazorpayClient("rzp_test_1fTjSvIIgBkt6M", "R2CDK8zeMTezejzP0yPNyjZh");
